...
async def get_auth_flow_info():
    ...
    flow_type = "auth_code" if not __auth_info.device_authorization_url else "device_code"
    return {
...
async def exchange_auth_code(code: str, code_verifier: str = None):
    ...
    async with httpx.AsyncClient() as client:
        data = {
            ...
            "redirect_uri": __auth_info.redirect_uri or "https://auth.globus.org/v2/web/auth-code",
        }
